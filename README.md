...
6. Add a domain of your choice to the list of allowed domains. The program addresses `www.yapfiles.ru` and `s00.yaplakal.com`, so add it if you just want to test the program.
